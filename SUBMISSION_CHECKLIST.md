# Zeitgeister submission checklist
...
- [ ] No GitHub personal access token is visible in the video, repository, submission, clipboard history, or notes.
- [ ] No Zeitgeister signing key is visible or committed.
- [ ] No generated capsule containing sensitive data is committed.
- [ ] Trust claims say local authentication—not encryption, immutability, or public authorship verification.

## Risk acknowledgment

- Official deadline: **July 21, 2026 at 5:00 PM PT**, which is **7:00 PM in Quito, Ecuador**.
